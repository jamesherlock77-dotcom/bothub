// deploy-commands.js
// Register slash commands (includes team options with autocomplete).
// Usage:
...
const commands = [
  ...
  new SlashCommandBuilder().setName('startscrim').setDescription('Challenge another team')
    .addStringOption(opt => opt
      .setName('team')
      .setDescription('The team you want to scrim')
      .setRequired(true)
...
(async () => {
  ...
  try {
    if (GUILD_ID) {
      ...
      console.log('Successfully reloaded guild application (/) commands for guild', GUILD_ID);
    } else {
